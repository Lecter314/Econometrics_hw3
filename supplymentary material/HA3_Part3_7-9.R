...
#Data preparation#
df <- as.data.frame(read_excel("C:/Users/Bai Xinyi/Downloads/preprocessed_data_part3.xlsx"))
...
results_olog_1 <- ologit.reg(ranking_multi ~ 
                               ...
                               credit_portfolio_18 + credit_portfolio_17,
                             data = our_data)
margins.oglmx(results_olog_1, ascontinuous = FALSE, atmeans = TRUE)
# AME - calculate AME
margins.oglmx(results_olog_1, ascontinuous = TRUE, AME = TRUE)
